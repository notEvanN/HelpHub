...
export const WidgetLoadingScreen = ({ organizationId }: { organizationId: string | null }) => {
    ...
    const contactSessonId = useAtomValue(contactSessionIdAtomFamily(organizationId || ""));
    ...
    useEffect(() => {
        ...
        validateContactSession({
            contactSessionId: contactSessonId,
        })
            .then((result) => {
    ...
    }, [step, contactSessonId, validateContactSession, setLoadingMessage]);
    ...
    useEffect(() => {
        ...
        const hasValidSession = contactSessonId  && sessionValid;
        setScreen(hasValidSession ? "selection" : "auth");
    }, [step, contactSessonId, sessionValid, setScreen]);
